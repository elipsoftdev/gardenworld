...
const PRODUCTS: Product[] = [
  {
    ...
    color: "#c7c8c4",
    images: [
      { src: "/images/products/premium-silver-blue-hose-front.webp", alt: "Base Premium Silver Garden World con manguera azul instalada, vista frontal", label: "Vista frontal instalada", fit: "contain" },
  ...
  },
  {
    ...
    color: "#292b28",
    images: [
      { src: "/images/products/black-blue-hose-front.webp", alt: "Base Black Garden World con manguera azul instalada, vista frontal", label: "Vista frontal instalada", fit: "contain" },
